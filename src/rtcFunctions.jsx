...
import {initRTMClient, joinChannel} from "./rtmFunction"
...
export default class RTCClient {
    ...
    createClient(data) {
        ...
        console.log("this._client", this._client.getRTCStats())
        this._created = true
        return this._client
    }x
    ...
    setClientRole(role) {
        console.log("setClientRole called")
