...
export const StateContainerProvider = ({children}) => {
    ...
    const methods = {
        ...
        setAgoraClient(clientInstance) {
            dispatch({type: 'clientSet', payload: clientInstance})
        },
        setRTMClient(rtmInstance) {
            dispatch({type: 'RTMClient', payload: rtmInstance})
        },
        setCodec(param) {
